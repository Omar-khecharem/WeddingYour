<div class="min-h-screen bg-gradient-to-b from-gray-50 to-white">
  <div class="max-w-4xl mx-auto px-4 py-8 sm:py-12">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
      ...
      <?php $orderRef = $order['order_number'] ?? ''; $waNumber = \App\Models\Setting::get('whatsapp_number', WHATSAPP_NUMBER); ?>
      <?php if ($orderRef && $waNumber): ?>
      <a href="https://wa.me/<?= e($waNumber) ?>?text=<?= urlencode("Hi! I just ordered #{$orderRef} from WeddingYour and need assistance.") ?>" target="_blank" rel="noopener noreferrer" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-green-500 text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-green-600 transition shadow-sm">
