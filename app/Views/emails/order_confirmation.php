...
<p style="color:#a0a0b8;margin:5px 0 0;font-size:13px">Confirmation de commande</p>
</td></tr>
<tr><td style="padding:30px 40px">
<p style="margin:0 0 20px;font-size:15px;color:#333">Merci pour votre commande&nbsp;! Voici un récapitulatif de vos achats.</p>
...
<tr><td style="background:#f8f8f8;padding:10px 12px;font-size:13px;font-weight:bold;color:#555;text-transform:uppercase;border-bottom:2px solid #ddd">Article</td>
<td style="background:#f8f8f8;padding:10px 12px;font-size:13px;font-weight:bold;color:#555;text-transform:uppercase;border-bottom:2px solid #ddd;text-align:center">Qt&eacute;</td>
<td style="background:#f8f8f8;padding:10px 12px;font-size:13px;font-weight:bold;color:#555;text-transform:uppercase;border-bottom:2px solid #ddd;text-align:right">Prix</td></tr>
...
<tr><td style="padding:6px 12px;font-size:14px;color:#555;text-align:right">Sous-total</td><td style="padding:6px 12px;font-size:14px;color:#333;text-align:right;width:120px"><?= number_format($order['subtotal'], 2) ?>&nbsp;&euro;</td></tr>
<?php if (!empty($order['discount']) && $order['discount'] > 0): ?>
<tr><td style="padding:6px 12px;font-size:14px;color:#e74c3c;text-align:right">R&eacute;duction</td><td style="padding:6px 12px;font-size:14px;color:#e74c3c;text-align:right">&ndash; <?= number_format($order['discount'], 2) ?>&nbsp;&euro;</td></tr>
<?php endif; ?>
<tr><td style="padding:6px 12px;font-size:14px;color:#555;text-align:right">Livraison (<?= $order['shipping_method_name'] ?>)</td><td style="padding:6px 12px;font-size:14px;color:#333;text-align:right"><?= number_format($order['shipping_cost'], 2) ?>&nbsp;&euro;</td></tr>
<tr><td style="padding:6px 12px;font-size:14px;color:#555;text-align:right">TVA</td><td style="padding:6px 12px;font-size:14px;color:#333;text-align:right"><?= number_format($order['tax'], 2) ?>&nbsp;&euro;</td></tr>
...
<tr><td style="font-size:14px;font-weight:bold;color:#333;padding-bottom:6px">Adresse de livraison</td></tr>
...
<p style="margin:25px 0 0;font-size:14px;color:#555">Paiement&nbsp;: <strong><?= $order['payment_method_name'] ?></strong></p>
</td></tr>
