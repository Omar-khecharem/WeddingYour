...
<p style="color:#a0a0b8;margin:5px 0 0;font-size:13px">Nouveau message de contact</p>
</td></tr>
<tr><td style="padding:30px 40px">
<p style="margin:0 0 20px;font-size:15px;color:#333">Un nouveau message a &eacute;t&eacute; envoy&eacute; depuis le formulaire de contact.</p>
...
<tr><td style="padding:10px 0;border-bottom:1px solid #eee;font-size:14px;color:#555"><strong>Sujet&nbsp;:</strong></td><td style="padding:10px 0;border-bottom:1px solid #eee;font-size:14px;color:#333"><?= $data['subject'] ?></td></tr>
