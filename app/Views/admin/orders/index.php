        ...
        <div class="max-w-[1400px] mx-auto py-6 px-4 lg:px-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Gérez les commandes de vos clients</p>
                </div>
                <span class="text-sm text-gray-500 bg-white px-4 py-2 rounded-lg border border-gray-200"><?= $pagination['totalItems'] ?? count($orders) ?> commandes</span>
            </div>
                ...
                <form method="GET" action="<?= url('admin/orders') ?>" class="flex flex-wrap items-end gap-3">
                    <div>
                        ...
                        <select name="status" class="border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-700 focus:ring-2 focus:ring-primary-red/20 focus:border-primary-red outline-none">
                            ...
                            <option value="processing" <?= $statusFilter === 'processing' ? 'selected' : '' ?>>En cours</option>
                    ...
                    <div class="flex-1 min-w-[200px]">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" value="<?= e($search) ?>" placeholder="Numéro de commande..." class="w-full border border-gray-300 rounded-lg pl-9 pr-3 py-2 text-sm text-gray-700 focus:ring-2 focus:ring-primary-red/20 focus:border-primary-red outline-none">
                        </div>
                    </div>
                    ...
                    <a href="<?= url('admin/orders') ?>" class="border border-gray-300 text-gray-600 px-5 py-2 rounded-lg text-sm font-medium hover:bg-gray-50 transition-all">Réinitialiser</a>
                </form>
            </div>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 text-left">
                                ...
                                <th class="px-5 py-3 text-gray-500 font-medium text-xs uppercase tracking-wider">Paiement</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-5 py-3">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700">Payé</span>
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-red-100 text-red-700">Échoué</span>
                                    <?php elseif ($pay === 'refunded'): ?>
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-700">Remboursé</span>
                                    <?php else: ?>
                                ...
                                <td class="px-5 py-3">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700"><?= $st === 'delivered' ? 'Livrée' : 'Confirmée' ?></span>
                                ...
                                <td class="px-5 py-3">
                                    <div class="flex items-center gap-1">
                                        <a href="<?= url('admin/orders/' . e($order['id'])) ?>" class="p-1.5 text-gray-400 hover:text-primary-red transition-colors" title="Voir"><i class="fa-solid fa-eye"></i></a>
                                        <a href="<?= url('admin/orders/' . e($order['id']) . '/edit') ?>" class="p-1.5 text-gray-400 hover:text-blue-600 transition-colors" title="Modifier"><i class="fa-solid fa-pen"></i></a>
                                        <button onclick="confirmDelete(<?= e($order['id']) ?>)" class="p-1.5 text-gray-400 hover:text-red-600 transition-colors" title="Supprimer"><i class="fa-solid fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
