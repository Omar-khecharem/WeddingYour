...
?>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500">File: <?= e(basename($logFile ?: 'error.log')) ?></p>
                </div>
                <div class="flex gap-2">
                    ...
                    <form method="POST" action="<?= url('admin/logs/clear') ?>" onsubmit="return confirm('Are you sure you want to clear all logs? This action cannot be undone.')">
